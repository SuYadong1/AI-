...
public class AppController {
    ...
    @PostMapping("/review")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> submitReview(@RequestBody ReviewRequest reviewRequest, HttpServletRequest request) {
        // 校验请求参数是否为空
        ThrowUtils.throwIf(reviewRequest == null, ErrorCode.PARAMS_ERROR, "请求参数非法");
